...
console.log('═══════════════════════════════════════════════════════════')
console.log('1. Close SignalHub (Cmd+Q)')
console.log('2. Clear logs:')
console.log('   rm -f ~/Library/Application\\ Support/SignalHub/logs/desktop.log')
console.log('')
console.log('3. Launch app:')
console.log('   open /Users/bsachi867/Documents/ai_ground/signalhub/desktop/dist/mac-arm64/SignalHub.app')
console.log('')
...
console.log('   tail -100 ~/Library/Application\\ Support/SignalHub/logs/desktop.log | grep -E "whisper|mps|device|transcrib|attempt"')
console.log('')
